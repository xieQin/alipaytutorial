...
session_start();
$_SESSION['WIDout_trade_no'] = $_POST['WIDout_trade_no'];
$_SESSION['WIDsubject'] = $_POST['WIDsubject'];
$_SESSION['WIDtotal_fee'] = $_POST['WIDtotal_fee'];
$_SESSION['WIDbody'] = $_POST['WIDbody'];
...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝即时到账交易</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <span><?php echo $_SESSION['WIDout_trade_no'];?></span>
                    </dd>
                    <dt>商品名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <!--<input size="30" name="WIDsubject" />-->
                        <span><?php echo $_SESSION['WIDsubject'];?></span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <!--<input size="30" name="WIDtotal_fee" />-->
                        <span><?php echo $_SESSION['WIDtotal_fee'];?></span>
                    </dd>
                    <dt>商品订单描述：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <!--<input size="30" name="WIDbody" />-->
                        <span><?php echo $_SESSION['WIDbody'];?></span>
                    </dd>
                    <!--<dt>商品展示地址：</dt>
                    <dd>
                        <span class="null-star">*</span>
